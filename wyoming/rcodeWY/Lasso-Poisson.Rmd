...
wyRawHepvu <- mutate(wyRawHepvu, DeathCount = round((NOD_Rate_2*E_TOTPOP)/100000))
```
...
```{r}
hist(wyRawHepvu$DeathCount, main = "Histogram of DeathCount", xlab = "DeathCount", col = "skyblue", border = "black")

```


```{r}
mean(wyRawHepvu$DeathCount)
var(wyRawHepvu$DeathCount)
