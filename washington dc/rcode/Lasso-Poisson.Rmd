---
title: "Lasso-Poisson Washington D.C"
...
```{r}
hist(dcRawHepvu$DeathCount, main = "Histogram of DeathCount", xlab = "DeathCount", col = "skyblue", border = "black",breaks=25)
...
```{r}
### LASSO REGRESSION ###
m_lasso <- glmnet(x_train, y_train, alpha = 1, family = "poisson")
...
cv_model <- cv.glmnet(x_train, y_train, alpha = 1,family = "poisson")
...
best_model <- glmnet(x_train, y_train, alpha = 1, lambda = best_lambda,family = "poisson")
coef(best_model)
```
